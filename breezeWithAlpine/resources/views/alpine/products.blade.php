...
<body class="bg-gray-100" x-data="data">
    ...
    <div class="container mx-auto p-4">
        ...
        <!-- Create Form -->
        {{--Ekhane @submit.prevent holo Alpine er ekta functionality. Eta dile form ta r submit hobe na --}}
        <form @submit.prevent="saveProduct()" id="createProductForm" class="mb-4 bg-white p-4 rounded shadow">
            ...
            <button @click="saveProduct()" type="submit" class="mt-2 px-4 py-2 bg-blue-500 text-white rounded hover:bg-blue-600">Add Product</button>
        </form>
    ...
    <script>
        const data = {
            ...
            //Every time se puro array ta k ekbar refresh korbe
            fetchProducts(){
